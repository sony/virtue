...
@hydra.main(version_base=None, config_path="./configs", config_name="vlm2vec_eval")
def main(config: DictConfig):
    ...
    # --- Model Loading ---
    hf_config = AutoConfig.from_pretrained(model_args.model_name, trust_remote_code=True, token=True)
